...
if __name__ == "__main__":
    ...
    result_sp_img_ga_filter_path = os.path.join(
        mp1_path, "images", "results", "salt_and_pepper_gaussian_filter.jpg"
    )
    result_sp_img_me_filter_path = os.path.join(
        mp1_path, "images", "results", "salt_and_pepper_median_filter.jpg"
    )
    result_ga_img_ga_filter_path = os.path.join(
        mp1_path, "images", "results", "gaussian_noise_gaussian_filter.jpg"
    )
    result_ga_img_me_filter_path = os.path.join(
        mp1_path, "images", "results", "gaussian_noise_median_filter.jpg"
    )
    # Read images
